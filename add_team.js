...
const MONGODB_URI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/dreamtrail';
...
.then(async () => {
  ...
  if (!settings.meetTheTeam) {
    settings.meetTheTeam = {};
  }
  
  settings.meetTheTeam.heroTitle = 'Meet The Team';
  settings.meetTheTeam.heroSubtitle = 'The People Behind Dreamtrail Explorers';
  settings.meetTheTeam.heroText = 'Meet the passionate explorers and riders who make every journey unforgettable.';
  
  settings.meetTheTeam.teamMembers = [
    {
      name: 'Vinayak Mehta',
